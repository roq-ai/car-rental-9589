            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem
                  ...
                  text={
                    data?.usage_start_time
                      ? format(parseISO(data?.usage_start_time as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                ...
                <FormListItem
                  ...
                  text={
                    data?.usage_end_time
                      ? format(parseISO(data?.usage_end_time as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />

                <FormListItem label="Total Miles" text={data?.total_miles} />
