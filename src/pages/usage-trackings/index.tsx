  ...
  const columns: ColumnType[] = [
    {
      ...
      accessorKey: 'usage_start_time',
      cell: ({ row: { original: record } }: any) =>
        record?.usage_start_time ? format(parseISO(record?.usage_start_time as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'usage_end_time',
      header: 'Usage End Time',
      accessorKey: 'usage_end_time',
      cell: ({ row: { original: record } }: any) =>
        record?.usage_end_time ? format(parseISO(record?.usage_end_time as unknown as string), 'dd-MM-yyyy') : '',
    },
    { id: 'total_miles', header: 'total_miles', accessorKey: 'total_miles' },
